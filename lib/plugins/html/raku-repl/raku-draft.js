...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const codeSection = `
        <img id="Camelia-code" title="Click to get Raku evaluation bar"
            src="/assets/images/Camelia.svg" style="display: collapse;">
        <div id="raku-input">
            <textarea rows="2" cols="40" id="raku-code"></textarea>
            <button id="raku-evaluate" class="raku-button">Evaluate Raku code</button>
            <button id="raku-hide" class="raku-button">Hide evaluate bar</button>
        </div>
